...
WELCOME_MESSAGES = [
    "به جمع ما خوش اومدی {mention}! امیدوارم بهمون خوش بگذره 🎉",
    "سلام {mention} عزیز! خوشحالیم که بهمون پیوستی 🌟",
...
GOODBYE_MESSAGES = [
    ...
    "{mention} ما رو ترک کرد. هر وقت خواستی برگرد 🚪",
...
JOKES = [
    ...
    "به سوسک میگن چرا نمیمیری؟ میگه مگه شما زندم میذارین؟ 🪳",
    "یارو رفته فست‌فود میگه یه پیتزای نیمه‌گرسنه میخوام! 🍕",
    "چرا ربات‌ها هیچوقت عصبانی نمیشن؟ چون همیشه ریست میشن! 🤖",
    "دو تا آهنربا دارن صحبت میکنن، یکیش میگه عاشقتم نمیتونم ولت کنم! 🧲",
    ...
    "یارو میره نونوایی میگه یه نون داغ میخوام، نونوا میگه داغشو نداریم سردشو داریم بذار زیر بغلت داغ میشه! 🍞",
    "دکتر به بیمار میگه باید رژیم بگیری، بیمار میگه باشه از فردا شروع میکنم، امروز رو مهمونتم! 🍽️",
]
